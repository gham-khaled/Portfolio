...
const skills = ['Node', 'Python', 'Step Function', 'Dynamodb', 'AWS SAM', 'AWS Lambda', 'Fargate'];
const features = ["Complex Step Functions workflows",
  "Live Alerts using Cloudwatch alerts, SNS notifications and Slack Webhooks",
];
const images = ["assets/projects/shifted/architecture.png", "assets/projects/shifted/fargate.png"];
