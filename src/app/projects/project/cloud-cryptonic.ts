...
const description = 'Cloud Cryptonic is a user-friendly GUI application that securely uploads and downloads files to and ' +
...
const skills = [ 'Python'];
const features = ["Seamless Client-Side Encryption/Decryption", "Integration with AWS S3"];
const images = ["assets/projects/cloud-cryptonic/main.png"];
const link = 'https://github.com/gham-khaled/Cloud-Cryptonic';

export const cloudCryptonic = new Project(projectName, description, skills, features, images, link, true);
